      ...
      <div class="hero-content-container">
        <div class="hero-content">
          <div class="hero-content-title">
            <h1 id='pagetitle' class='title'><span><?php print $hero_title; ?></span></h1>        
          </div>
        </div>
      </div>  
    </div>
  ...
  <section class="page-main-wrapper" id="page-main-wrapper">
      <div class="container">
          <div class="row">
              ...
              <div class="col-md-9"><div class="content-page-with-sidebar"><?php print render($page['content']); ?><?php _royalcommission_render_prevnext(); ?></div></div>
          </div>  
      </div>
  </section>
<?php endif; ?>
